      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/visitors',
            redirect: (context, state) {
              // Only Super Admin, Admin Team (Reception/Admin — visitor
              // verification + Building Management handoff), and
              // Security manage visitors from the main shell; a
              // visitor's own guest-session check-in is a separate,
              // unauthenticated route (`/kiosk`), not shown here.
